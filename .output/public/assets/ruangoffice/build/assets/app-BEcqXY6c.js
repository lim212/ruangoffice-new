...
function yi(e) {
  (V.includes(e) || V.push(e), wi());
}
function bi(e) {
  let t = V.indexOf(e);
  t !== -1 && t > ft && V.splice(t, 1);
}
function wi() {
  !lt && !ut && ((ut = !0), queueMicrotask(xi));
}
function xi() {
  ((ut = !1), (lt = !0));
  for (let e = 0; e < V.length; e++) (V[e](), (ft = e));
  ((V.length = 0), (ft = -1), (lt = !1));
}
var se,
  te,
  oe,
...
function Oi(e) {
  var t, n;
  for (
    (t = e._x_effects) == null || t.forEach(bi);
    (n = e._x_cleanups) != null && n.length;

  )
    e._x_cleanups.pop()();
}
var Mt = new MutationObserver(Dt),
  jt = !1;
function It() {
  (Mt.observe(document, {
    subtree: !0,
...
function qn() {
  (Ri(), Mt.disconnect(), (jt = !1));
}
var fe = [];
function Ri() {
  let e = Mt.takeRecords();
  fe.push(() => e.length > 0 && Dt(e));
  let t = fe.length;
  queueMicrotask(() => {
...
function Dt(e) {
  ...
  for (let s of n) t.has(s) || Bn.forEach((o) => o(s));
  t.forEach((s) => {
...
function pt(e, t, n) {
  if ((typeof t == "string" && (t = t.split(".")), t.length === 1)) e[t[0]] = n;
    ...
    return (e[t[0]] || (e[t[0]] = {}), pt(e[t[0]], t.slice(1), n));
  }
}
var Jn = {};
function j(e, t) {
...
function Xn(e, t) {
  ...
  ht(n, e);
  let r = [n, ...re(e)],
    i = typeof t == "function" ? Ii(r, t) : Di(r, t, e);
  return Mi.bind(null, e, t, i);
}
function Ii(e, t) {
  return (n = () => {}, { scope: r = {}, params: i = [] } = {}) => {
    let s = t.apply(xe([r, ...e]), i);
    Be(n, s);
  };
}
var et = {};
  ...
  let n = Object.getPrototypeOf(async function () {}).constructor,
    ...
    s = (() => {
      try {
        ...
        return (
          Object.defineProperty(o, "name", { value: `[Alpine] ${e}` }),
          o
        );
      } catch (o) {
        return (ye(o, t, e), Promise.resolve());
      }
    })();
  return ((et[e] = s), s);
}
function Di(e, t, n) {
  ...
  return (i = () => {}, { scope: s = {}, params: o = [] } = {}) => {
    ...
    if (typeof r == "function") {
      let c = r(r, a).catch((u) => ye(u, n, t));
      r.finished
        ? (Be(i, r.result, a, o, n), (r.result = void 0))
        : c
            .then((u) => {
              Be(i, u, a, o, n);
            })
...
function Be(e, t, n, r, i) {
  if (Le && typeof t == "function") {
    ...
    s instanceof Promise
      ? s.then((o) => Be(e, o, n, r)).catch((o) => ye(o, i, t))
      : e(s);
  } else
...
function tr(e = () => {}) {
  return ({ name: t, value: n }) => {
    let { name: r, value: i } = nr.reduce((s, o) => o(s), {
      name: t,
      value: n,
    });
...
function zi(e, t) {
  let n = J.indexOf(e.type) === -1 ? mt : e.type,
    r = J.indexOf(t.type) === -1 ? mt : t.type;
...
function qe(e, t = !1) {
  return Ee(e, (n) => {
    if ((t ? ar() : or()).some((i) => n.matches(i))) return !0;
  });
}
function Ee(e, t) {
  if (e) {
...
function He(e, t) {
  return typeof t == "object" && t !== null ? Yi(e, t) : Zi(e, t);
}
function Yi(e, t) {
  let n = {};
  return (
...
R(
  ...
  (e, { value: t, modifiers: n, expression: r }, { evaluate: i }) => {
    (typeof r == "function" && (r = i(r)),
      r !== !1 && (!r || typeof r == "boolean" ? ts(e, n, t) : es(e, r, t)));
  },
);
function es(e, t, n) {
  (fr(e, Kt, ""),
...
function ts(e, t, n) {
  ...
  let o = !t.includes("opacity") && !t.includes("scale"),
    ...
    u = a ? 0 : 1,
    l = c ? de(t, "scale", 95) / 100 : 1,
    p = de(t, "delay", 0) / 1e3,
    _ = de(t, "origin", "center"),
    w = "opacity, transform",
    h = de(t, "duration", 150) / 1e3,
    g = de(t, "duration", 75) / 1e3,
  ...
  if (br(e))
    ...
    Number.isInteger(t)
      ...
      : !Array.isArray(t) &&
        ...
        ? (e.value = String(t))
        : Array.isArray(t)
          ? (e.checked = t.some((n) => un(n, e.value)))
          : (e.checked = !!t);
  else if (e.tagName === "SELECT") ps(e, t);
  else {
    if (e.value === t) return;
    e.value = t === void 0 ? "" : t;
  }
...
function ys(e, t, n, r = !0) {
  ...
  if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
    ...
    return ((i.extract = r), Wn(() => X(e, i.expression)));
  }
  return yr(e, t, n);
}
function yr(e, t, n) {
...
function Er({ get: e, set: t }, { get: n, set: r }) {
  let i = !0,
    s,
    o = te(() => {
      let a = e(),
...
var K = {},
  ln = !1;
function ws(e, t) {
  if ((ln || ((K = se(K)), (ln = !0)), t === void 0)) return K[e];
  ((K[e] = t),
    zn(K[e]),
    typeof t == "object" &&
      t !== null &&
...
function Es(e, t) {
  ...
  return e instanceof Element ? Ar(e, n()) : ((Sr[e] = n), () => {});
}
function Ss(e) {
  return (
...
var Os = {
    ...
    version: "3.14.3",
    flushAndStopDeferringMutations: Ci,
    dontAutoEvaluateFunctions: Wn,
    disableEffectScheduling: Ei,
    startObservingMutations: It,
    stopObservingMutations: qn,
    setReactivityEngine: Si,
    onAttributeRemoved: $n,
    onAttributesAdded: kn,
    closestDataStack: re,
    skipDuringClone: z,
    onlyDuringClone: rs,
    addRootSelector: cr,
...
var Ts = Object.freeze({}),
  ...
  Ke = (e, t) => Cs.call(e, t),
  G = Array.isArray,
  ge = (e) => Or(e) === "[object Map]",
  Ps = (e) => typeof e == "string",
  ...
  Rr = (e) => Or(e).slice(8, -1),
  Vt = (e) =>
    Ps(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e,
  Ls = (e) => {
...
function Ds(e, t) {
  const n = function () {
    ...
    if (!pe.includes(n)) {
      Cr(n);
      try {
        return ($s(), pe.push(n), (D = n), e());
      } finally {
        (pe.pop(), Pr(), (D = pe[pe.length - 1]));
      }
    }
  };
  return (
  ...
  if (t === "clear") o.forEach(c);
    ...
    switch ((n !== void 0 && c(o.get(n)), t)) {
      case "add":
        G(e)
          ? Vt(n) && c(o.get("length"))
          : (c(o.get(Y)), ge(e) && c(o.get(St)));
        break;
      case "delete":
        G(e) || (c(o.get(Y)), ge(e) && c(o.get(St)));
        break;
      case "set":
        ge(e) && c(o.get(Y));
        break;
...
var Us = Rs("__proto__,__v_isRef,__isVue"),
  Nr = new Set(
...
function zs() {
  ...
  return (
    ["includes", "indexOf", "lastIndexOf"].forEach((t) => {
      e[t] = function (...n) {
        const r = E(this);
        for (let s = 0, o = this.length; s < o; s++) M(r, "get", s + "");
        const i = r[t](...n);
...
function Lr(e = !1, t = !1) {
  return function (r, i, s) {
    ...
    if (i === "__v_raw" && s === (e ? (t ? io : Ir) : t ? ro : jr).get(r))
      return r;
    const o = G(r);
    if (!e && o && Ke(fn, i)) return Reflect.get(fn, i, s);
    const a = Reflect.get(r, i, s);
    return (Wt(i) ? Nr.has(i) : Us(i)) || (e || M(r, "get", i), t)
      ? a
      : At(a)
        ? !o || !Vt(i)
          ? a.value
...
function Js(e = !1) {
  return function (n, r, i, s) {
    let o = n[r];
    if (!e && ((i = E(i)), (o = E(o)), !G(n) && At(o) && !At(i)))
      return ((o.value = i), !0);
    const a = G(n) && Vt(r) ? Number(r) < n.length : Ke(n, r),
      c = Reflect.set(n, r, i, s);
    return (
      n === E(s) && (a ? Tr(i, o) && H(n, "set", r, i, o) : H(n, "add", r, i)),
      c
    );
  };
}
...
function Vs(e, t) {
  ...
  return ((!Wt(t) || !Nr.has(t)) && M(e, "has", t), n);
}
function Xs(e) {
  return (M(e, "iterate", G(e) ? "length" : Y), Reflect.ownKeys(e));
}
var Gs = { get: qs, set: Ks, deleteProperty: Ws, has: Vs, ownKeys: Xs },
  Ys = {
    get: Hs,
    set(e, t) {
      return (
...
function dn(e) {
  e = E(e);
  const t = E(this);
  return (We(t).has.call(t, e) || (t.add(e), H(t, "add", e, e)), this);
}
function pn(e, t) {
  t = E(t);
  const n = E(this),
    { has: r, get: i } = We(n);
  let s = r.call(n, e);
  s ? Mr(n, r, e) : ((e = E(e)), (s = r.call(n, e)));
  const o = i.call(n, e);
  return (
    n.set(e, t),
    s ? Tr(t, o) && H(n, "set", e, t, o) : H(n, "add", e, t),
    this
  );
}
function hn(e) {
  ...
  return (r, i, s) =>
    i === "__v_isReactive"
      ...
      : i === "__v_isReadonly"
        ...
        : i === "__v_raw"
          ? r
          : Reflect.get(Ke(n, i) && i in r ? n : r, i, s);
}
var to = { get: Fr(!1) },
  no = { get: Fr(!0) };
function Mr(e, t, n) {
...
function oo(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : so(Rr(e));
}
function Qt(e) {
  return e && e.__v_isReadonly ? e : Dr(e, !1, Gs, to, jr);
}
function Br(e) {
  return Dr(e, !0, Ys, no, Ir);
}
...
j("nextTick", () => zt);
j("dispatch", (e) => me.bind(me, e));
j("watch", (e, { evaluateLater: t, cleanup: n }) => (r, i) => {
  let s = t(r),
    a = jn(() => {
      let c;
      return (s((u) => (c = u)), c);
...
j(
  "refs",
  (e) => (e._x_refs_proxy || (e._x_refs_proxy = xe(ao(e))), e._x_refs_proxy),
);
function ao(e) {
  let t = [];
  return (
...
function vt(e, t, n, r) {
  let i = e,
    ...
    a = (c, u) => (l) => u(c, l);
  if (
    (n.includes("dot") && (t = po(t)),
    n.includes("camel") && (t = ho(t)),
...
function go(e, t) {
  ...
  if (n.length === 0 || (n.length === 1 && gn(e.key).includes(n[0]))) return !1;
  ...
  return (
    ...
    !(
      ...
      (qr(e.type) || gn(e.key).includes(n[0]))
    )
  );
}
function gn(e) {
...
R("model", (e, { modifiers: t, expression: n }, { effect: r, cleanup: i }) => {
  ...
  let c = () => {
      let _;
      return (o((w) => (_ = w)), yn(_) ? _.get() : _);
    },
    u = (_) => {
      let w;
      (o((h) => (w = h)),
        yn(w) ? w.set(_) : a(() => {}, { scope: { __placeholder: _ } }));
    };
  typeof n == "string" &&
    e.type === "radio" &&
    S(() => {
  ...
  if (
    ...
    let _ = vt(e.form, "reset", [], (w) => {
      zt(() => e._x_model && e._x_model.set(rt(e, t, { target: e }, c())));
    });
    i(() => _());
  }
  ((e._x_model = {
...
R("cloak", (e) =>
  queueMicrotask(() => S(() => e.removeAttribute(ae("cloak")))),
);
ur(() => `[${ae("init")}]`);
R(
  "init",
...
Hr.inline = (e, { value: t, modifiers: n, expression: r }) => {
  t &&
...
function xo(e) {
  return q ? (xt ? !0 : e.hasAttribute("data-has-alpine-state")) : !1;
}
R("show", (e, { modifiers: t, expression: n }, { effect: r }) => {
  ...
  r(() =>
    i((p) => {
      (!l && p === u) ||
        (t.includes("immediate") && (p ? a() : s()), c(p), (u = p), (l = !1));
    }),
  );
});
...
function Eo(e, t, n, r) {
  let i = (o) => typeof o == "object" && !Array.isArray(o),
    s = e;
  n((o) => {
    (Ao(o) && o >= 0 && (o = Array.from(Array(o).keys(), (d) => d + 1)),
      o === void 0 && (o = []));
    let a = e._x_lookup,
      c = e._x_prevKeys,
      u = [],
    ...
    if (i(o))
      o = Object.entries(o).map(([d, m]) => {
        ...
        (r(
          (x) => {
            (l.includes(x) && F("Duplicate key on x-for", e), l.push(x));
          },
          { scope: { index: d, ...b } },
        ),
          u.push(b));
      ...
      for (let d = 0; d < o.length; d++) {
        ...
        (r(
          (b) => {
            (l.includes(b) && F("Duplicate key on x-for", e), l.push(b));
          },
          { scope: { index: d, ...m } },
        ),
          u.push(m));
    ...
    for (let d = 0; d < p.length; d++) {
      ...
      (we(C, B, s),
        (C._x_refreshXForScope = (ne) => {
          Object.entries(ne).forEach(([Oe, mi]) => {
            B[Oe] = mi;
          });
        }),
        S(() => {
...
Se.setEvaluator(Xn);
Se.setReactivityEngine({ reactive: Qt, effect: js, release: Is, raw: E });
var vo = Se,
  Kr = vo;
function Jr(e, t) {
  return function () {
...
const { toString: Oo } = Object.prototype,
  { getPrototypeOf: en } = Object,
  Xe = ((e) => (t) => {
    const n = Oo.call(t);
    return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
  })(Object.create(null)),
  I = (e) => ((e = e.toLowerCase()), (t) => Xe(t) === e),
  Ge = (e) => (t) => typeof t === e,
  { isArray: ue } = Array,
  be = Ge("undefined");
function Ro(e) {
...
const Co = Ge("string"),
  ...
  [Do, ko, $o, Uo] = ["ReadableStream", "Request", "Response", "Headers"].map(
    I,
  ),
  qo = (e) =>
...
const Ho = (e, t, n, { allOwnKeys: r } = {}) => (
    Ae(
      t,
      (i, s) => {
        n && L(i) ? (e[s] = Jr(i, n)) : (e[s] = i);
      },
      { allOwnKeys: r },
    ),
    e
  ),
  zo = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e),
  Ko = (e, t, n, r) => {
  ...
  Xo = (
    (e) => (t) =>
      e && t instanceof e
  )(typeof Uint8Array < "u" && en(Uint8Array)),
  Go = (e, t) => {
  ...
  xn = "0123456789",
  Zr = { DIGIT: xn, ALPHA: st, ALPHA_DIGIT: st + st.toUpperCase() + xn },
  sa = (e = 16, t = Zr.ALPHA_DIGIT) => {
    let n = "";
    const { length: r } = t;
...
const aa = (e) => {
  ...
  ca = I("AsyncFunction"),
  ua = (e) => e && (Ye(e) || L(e)) && L(e.then) && L(e.catch),
  Qr = ((e, t) =>
    e
      ? setImmediate
      : t
        ? ((n, r) => (
            W.addEventListener(
              "message",
              ({ source: i, data: s }) => {
                i === W && s === n && r.length && r.shift()();
              },
              !1,
            ),
            (i) => {
              (r.push(i), W.postMessage(n, "*"));
            }
          ))(`axios@${Math.random()}`, [])
        : (n) => setTimeout(n))(
  ...
  la =
    typeof queueMicrotask < "u"
      ...
      : (typeof process < "u" && process.nextTick) || Qr,
  f = {
    isArray: ue,
    isArrayBuffer: Wr,
    isBuffer: Ro,
...
const pa = f.toFlatObject(f, {}, null, function (t) {
...
function Ze(e, t, n) {
  ...
  function l(h, g, d) {
    ...
    return Rt(h) ? !0 : (t.append(En(d, g, s), u(h)), !1);
  }
  const p = [],
    _ = Object.assign(pa, {
      defaultVisitor: l,
      ...
      (p.push(h),
        f.forEach(h, function (m, b) {
          (!(f.isUndefined(m) || m === null) &&
            i.call(t, m, f.isString(b) ? b.trim() : b, g, _)) === !0 &&
            w(m, g ? g.concat(b) : [b]);
        }),
        p.pop());
    }
...
function ii(e, t, n) {
  ...
  if (
    (i
      ? (s = i(t, n))
      : (s = f.isURLSearchParams(t) ? t.toString() : new tn(t, n).toString(r)),
    s)
  ) {
    const o = e.indexOf("#");
    (o !== -1 && (e = e.slice(0, o)),
...
const si = {
  ...
  _a = typeof URLSearchParams < "u" ? URLSearchParams : tn,
  ma = typeof FormData < "u" ? FormData : null,
  ga = typeof Blob < "u" ? Blob : null,
  ya = {
    isBrowser: !0,
    classes: { URLSearchParams: _a, FormData: ma, Blob: ga },
    protocols: ["http", "https", "file", "blob", "url", "data"],
  },
  nn = typeof window < "u" && typeof document < "u",
  Tt = (typeof navigator == "object" && navigator) || void 0,
  ba =
    nn &&
    (!Tt || ["ReactNative", "NativeScript", "NS"].indexOf(Tt.product) < 0),
  wa =
    typeof WorkerGlobalScope < "u" &&
    self instanceof WorkerGlobalScope &&
    typeof self.importScripts == "function",
  xa = (nn && window.location.href) || "http://localhost",
  Ea = Object.freeze(
    ...
    return (
      ...
      c
        ...
        : ((!i[o] || !f.isObject(i[o])) && (i[o] = []),
          t(n, r, i[o], s) && f.isArray(i[o]) && (i[o] = va(i[o])),
          !a)
    );
  }
  ...
  transformRequest: [
    function (t, n) {
      ...
      if ((s && f.isHTMLForm(t) && (t = new FormData(t)), f.isFormData(t)))
        return i ? JSON.stringify(oi(t)) : t;
      if (
        f.isArrayBuffer(t) ||
        f.isBuffer(t) ||
        f.isStream(t) ||
      ...
      return s || i ? (n.setContentType("application/json", !1), Oa(t)) : t;
    },
  ],
  transformResponse: [
    function (t) {
...
class N {
  ...
  set(t, n, r) {
    ...
    else if (f.isString(t) && (t = t.trim()) && !Pa(t)) o(Ta(t), n);
  ...
  delete(t, n) {
    ...
    function s(o) {
      if (((o = he(o)), o)) {
        ...
        a && (!n || ot(r, r[a], a, n)) && (delete r[a], (i = !0));
      }
    }
  ...
  clear(t) {
    ...
    for (; r--; ) {
      const s = n[r];
      (!t || ot(this, this[s], s, t, !0)) && (delete this[s], (i = !0));
    }
    return i;
  }
  normalize(t) {
...
`);
  ...
  static accessor(t) {
    const r = (this[vn] = this[vn] = { accessors: {} }).accessors,
      i = this.prototype;
    function s(o) {
      const a = he(o);
      r[a] || (La(i, o), (r[a] = !0));
...
function ja(e, t) {
  ...
  const o = (u, l = Date.now()) => {
    ((n = l), (i = null), s && (clearTimeout(s), (s = null)), e.apply(null, u));
  };
  return [
    (...u) => {
      const l = Date.now(),
...
const $e = (e, t, n = 3) => {
  ...
  Rn =
    ...
    (...t) =>
      f.asap(() => e(...t)),
  Ia = P.hasStandardBrowserEnv
    ? (function () {
        const t = P.navigator && /(msie|trident)/i.test(P.navigator.userAgent),
...
function ui(e, t) {
  return e && !Da(t) ? ka(e, t) : t;
}
const Tn = (e) => (e instanceof N ? { ...e } : e);
function ee(e, t) {
  t = t || {};
  const n = {};
  function r(u, l, p) {
...
const li = (e) => {
    ...
    ((t.headers = o = N.from(o)),
      (t.url = ii(ui(t.baseURL, t.url), e.params, e.paramsSerializer)),
      a &&
        o.set(
          "Authorization",
          "Basic " +
    ...
    if (
      ...
      (r && f.isFunction(r) && (r = r(t)), r || (r !== !1 && Ia(t.url)))
    ) {
      const u = i && s && Ba.read(s);
      u && o.set(i, u);
    }
    return t;
  },
  $a = typeof XMLHttpRequest < "u",
  Ua =
    $a &&
    function (e) {
      return new Promise(function (n, r) {
        ...
        let { responseType: a, onUploadProgress: c, onDownloadProgress: u } = i,
          l,
          p,
          _,
          w,
    ...
    if (t || n) {
      ...
      const s = function (u) {
        if (!i) {
          ...
          r.abort(
            l instanceof y ? l : new le(l instanceof Error ? l.message : l),
          );
        }
      };
      let o =
        t &&
        setTimeout(() => {
          ((o = null), s(new y(`timeout ${t} of ms exceeded`, y.ETIMEDOUT)));
        }, t);
      const a = () => {
        e &&
          (o && clearTimeout(o),
  ...
  za = async function* (e, t) {
    for await (const n of Ka(e)) yield* Ha(n, t);
  },
  Ka = async function* (e) {
  ...
  fi = Qe && typeof ReadableStream == "function",
  Ja =
    Qe &&
  ...
  Pn = 64 * 1024,
  Ct = fi && di(() => f.isReadableStream(new Response("").body)),
  Ue = { stream: Ct && ((e) => e.body) };
Qe &&
  ((e) => {
    ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((t) => {
      !Ue[t] &&
        (Ue[t] = f.isFunction(e[t])
          ? (n) => n[t]()
          : (n, r) => {
              throw new y(
...
const Va = async (e) => {
  ...
  Ga =
    ...
    (async (e) => {
      ...
      let w = qa([i, s && s.toAbortSignal()], o),
        h;
      const g =
        w &&
        w.unsubscribe &&
      ...
      try {
        if (
          ...
          if (
            (f.isFormData(r) &&
              (C = v.headers.get("content-type")) &&
              l.setContentType(C),
            v.body)
          ) {
            const [B, ne] = On(d, $e(Rn(c)));
            r = Cn(v.body, Pn, B, ne);
          }
        }
        ...
        u = u || "text";
        let A = await Ue[f.findKey(Ue, u) || "text"](b, e);
        return (
          !x && g && g(),
        ...
        throw (
          ...
          m && m.name === "TypeError" && /fetch/i.test(m.message)
            ? Object.assign(new y("Network Error", y.ERR_NETWORK, e, h), {
                cause: m.cause || m,
              })
...
const Nn = (e) => `- ${e}`,
  Ya = (e) => f.isFunction(e) || e === null || e === !1,
  pi = {
    getAdapter: (e) => {
      e = f.isArray(e) ? e : [e];
      const { length: t } = e;
      ...
      for (let s = 0; s < t; s++) {
        ...
        if (
          ((r = n),
          !Ya(n) && ((r = Pt[(o = String(n)).toLowerCase()]), r === void 0))
        )
...
function Ln(e) {
  return (
    ...
    pi
      .getAdapter(e.adapter || ve.adapter)(e)
      .then(
        function (r) {
          return (
            ct(e),
            (r.data = at.call(e, e.transformResponse, r)),
...
const Nt = { assertOptions: Za, validators: rn },
  U = Nt.validators;
class Z {
  constructor(t) {
    ((this.defaults = t),
...
f.forEach(["delete", "get", "head", "options"], function (t) {
  Z.prototype[t] = function (n, r) {
    return this.request(
      ee(r || {}, { method: t, url: n, data: (r || {}).data }),
    );
  };
});
...
function _i(e) {
  const t = new Z(e),
    n = Jr(Z.prototype.request, t);
  return (
    f.extend(n, Z.prototype, t, { allOwnKeys: !0 }),
...
O.mergeConfig = ee;
O.AxiosHeaders = N;
O.formToJSON = (e) => oi(f.isHTMLForm(e) ? new FormData(e) : e);
O.getAdapter = pi.getAdapter;
O.HttpStatusCode = Lt;
O.default = O;
window.axios = O;
