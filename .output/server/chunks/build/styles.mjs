...
const styles = {
  "pages/index.vue": () => import('./index-styles.Ddwk77G7.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&lang.css": () => import('./index-styles.DV8ttYMU.mjs').then(interopDefault),
