...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "C:/Users/FELIX/WebstormProjects/ruangoffice-new/node_modules/ufo/dist/index.mjs";
...
import { _ as _export_sfc, u as useHead } from "./_plugin-vue_export-helper-Dn0XNCNu.js";
import "ofetch";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-2ba11e48><div class="fixed left-0 right-0 spotlight z-10" data-v-2ba11e48></div><div class="max-w-520px text-center z-20" data-v-2ba11e48><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-2ba11e48>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-2ba11e48>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-2ba11e48>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2ba11e48"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-Cima2yK6.js.map
