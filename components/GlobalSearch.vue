  ...
  <div class="relative">
    ...
    <div class="relative group">
      <input 
        ...
        class="pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl focus:border-amber-400 focus:outline-none focus:ring-4 focus:ring-amber-100 transition-all duration-300 text-sm w-56 bg-slate-50 group-hover:bg-white group-hover:shadow-md"
      />
      <svg class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-slate-400 group-hover:text-amber-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
